...
// config Driven UI
const RestrauntCard = ({ name , cuisines , lastMileTravelString }) => {
  
    return (
        <div className="card">
            {/* <img src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/gzuvzwwsxk5f2n8tid5q" + restaurantList[0].data?.cloudinaryImageId} alt="logo" /> */}
            <h2>{name}</h2>
            <h3>{cuisines.join(" , ")}</h3>
